...
const BookingToday = () => {
  ...
  const fetchOrderDetails = async () => {
    const response = await fetch(SummaryApi.getBookingTableToday.url, {
      method: SummaryApi.getBookingTableToday.method,
      credentials: "include",
    });
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-coffee-brown">Bookings Today</h1>
        <p className="text-gray-600 mt-2">  
          Below is a list of all your table bookings today.
        </p>
      </div>
