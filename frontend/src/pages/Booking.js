  ...
  return (
    <div className="container mx-auto py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-2">Please fill out the form below to booking a table.</p>
        <p className="text-gray-800 mt-2">
          E-mail:{" "}
          <a href="mailto:hungb2103500@student.ctu.edu.vn" className="text-blue-600">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <p className="text-gray-800 mt-2">
          ...
          <img src={image0} alt="Location map" className="w-full h-80 object-cover rounded-lg mb-4" />
        </div>

        <div>
          <form className="bg-gray-100 p-6 rounded-lg shadow-lg" onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="tableId" className="text-sm font-medium text-gray-700 mb-2 hidden">
                Table ID
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="userId" className="hidden text-sm font-medium text-gray-700 mb-2">
                User ID
              </label>
              <input
                type="text"
            ...
            <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              className="w-full p-3 border border-gray-300 rounded-md bg-gray-200 cursor-not-allowed"
              >
                Bàn số {tableData?.tableNumber} - {tableData?.tableArea} - {tableData?.tableType}
              </div>
            </div>
            ...
            <div className="mb-4">
              <img src={tableData?.tableImage[0]} alt="Table" className="w-full h-80 object-cover rounded-lg mb-4" />
            </div>
            ...
            <button type="submit" className="w-full bg-coffee-brown text-white py-3 rounded-md hover:bg-opacity-90 transition-colors">
              Submit
            </button>
          </form>
        </div>
